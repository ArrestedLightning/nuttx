...
#ifndef __ARCH_ARM_SRC_STM32F0L0G0_HARDWARE_STM32_USBFS_H
#define __ARCH_ARM_SRC_STM32F0L0G0_HARDWARE_STM32_USBFS_H
...
#define STM32_USB_BTABLE_RADDR(ep,o) ((((uint32_t)STM32_USBRAM_BASE + ((ep) << 3)) + (o)))
...
#endif /* CONFIG_STM32F0L0G0_USB */
#endif /* __ARCH_ARM_SRC_STM32F0L0G0_HARDWARE_STM32_USBFS_H */
